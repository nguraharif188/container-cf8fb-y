...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-cf8fb-y.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-cf8fb-y.containers.anotherwebservice.com/
...
```
git clone git@github.com:nguraharif188/container-cf8fb-y.git
cd container-cf8fb-y
```
...
```
docker attach container-cf8fb-y
```
